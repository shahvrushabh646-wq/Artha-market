...
function PreciousMetals() {
  ...
  return <Section title="Gold & Silver" hint="Moneycontrol Mumbai prices">
    ...
    </div><p className="mt-2 text-[11px] text-subtle">Source: Moneycontrol. Gold and Silver prices shown here are the same Mumbai prices published by Moneycontrol. Data is refreshed by the app every 60 seconds.</p>
  </Section>;
}