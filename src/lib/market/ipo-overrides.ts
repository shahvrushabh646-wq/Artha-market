...
export function applyVerifiedIpoOverrides(ipos: Ipo[]): Ipo[] {
  return ipos.map((ipo) => {
    const key = ipo.name.toLowerCase().replace(/limited|ltd\.?|[^a-z0-9]+/g, "").replace(/\s+/g, "");
    ...
    return {
      ...
      revenues: [
        { year: "FY24", value: 570.14 },
        { year: "FY25", value: 596.42 },
        { year: "FY26", value: 753.04 },
      ],
      profits: [
        { year: "FY24", value: 305.34 },
        { year: "FY25", value: 355.32 },
        { year: "FY26", value: 407.84 },
      ],
      eps: [
        { year: "FY24", value: 9.4 },
        { year: "FY25", value: 10.94 },
        { year: "FY26", value: 12.55 },
      ],
      subscription: ipo.subscription ?? 0.38,
      subscriptionSource: ipo.subscriptionSource ?? "Moneycontrol — પ્રથમ દિવસ",
      subscriptionCategories: ipo.subscriptionCategories.length ? ipo.subscriptionCategories : [
        { category: "QIB", value: 0.09 },
        { category: "NII", value: 0.33 },
        { category: "Retail", value: 0.56 },
      ],
