...
export const PERIOD_MAP: Record<ChartPeriod, { range: string; interval: string }> = {
  ...
  "3Y": { range: "5y", interval: "1d" },
  "5Y": { range: "5y", interval: "1d" },
  MAX: { range: "max", interval: "1mo" },
};

export const DISCLAIMER =
  "For education only — not financial, investment, tax or legal advice. Market data may be delayed or incomplete. Verify independently before acting.";

export const DATA_NOTE = "Live quotes via Yahoo Finance. Fundamentals via Groww. Data may be delayed.";
